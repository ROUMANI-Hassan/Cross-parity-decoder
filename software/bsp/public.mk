...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../DE0_CV.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../DE0_CV_QSYS.sopcinfo
...
# Design Name 
# setting SOPC_NAME is DE0_CV_QSYS
SOPC_NAME := DE0_CV_QSYS
...
# The SOPC System ID 
# setting SOPC_SYSID is 3405700810
SOPC_SYSID_FLAG += --id=3405700810
ELF_PATCH_FLAG  += --id 3405700810

# The SOPC System ID Base Address 
# setting SOPC_SYSID_BASE_ADDRESS is 0x5040060
SOPC_SYSID_FLAG += --sidp=0x5040060
ELF_PATCH_FLAG  += --sidp 0x5040060

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1781875609
SOPC_SYSID_FLAG += --timestamp=1781875609
ELF_PATCH_FLAG  += --timestamp 1781875609
